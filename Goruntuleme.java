...
public class Goruntuleme {
    ...
    public void Gitar_Goruntuleme(char secim1, char secim2){
        if(secim1 =='o' && (secim2 == 'a' || secim2 == 'A') || secim1 == 'O' &&(secim2=='a' || secim2=='A')){
            gitar.Ozellikler();
            gitar.Akor_Basma();
        }
        else if(secim1 =='o' && (secim2 == 's' || secim2 == 'S') || secim1 == 'O' &&(secim2=='s' || secim2=='S')){
            gitar.Ozellikler();
            gitar.Solo_Calma();
        }
        else if(secim1 =='a' && (secim2 == 's' || secim2 == 'S') || secim1 == 'A' &&(secim2=='s' || secim2=='S')){
            gitar.Akor_Basma();
            gitar.Solo_Calma();
        }
        }
    ...
    public void Keman_Goruntuleme(char secim1, char secim2){
        if(secim1 =='o' && (secim2 == 'n' || secim2 == 'N') || secim1 == 'O' &&(secim2=='n' || secim2=='N')){
            keman.Ozellikler();
            keman.Yay_Cekme();
        }
        else if(secim1 =='o' && (secim2 == 's' || secim2 == 'S') || secim1 == 'O' &&(secim2=='s' || secim2=='S')){
